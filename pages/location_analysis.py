"""
Location Traffic Analysis Page

Detailed traffic analysis for selected location including metrics,
...
def main() -> None:
    ...
    if preselected_location:
        ...
        st.markdown("Select a location from the sidebar to begin analysis.")
        st.info("💡 **Tip:** Visit the Map page to explore all available locations visually.")

    # Setup sidebar and load data
    selected_location, locations, viz_library = setup_sidebar_filters(preselected_location)
